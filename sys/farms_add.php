...
<html lang="en">
<head>
	<title>Agriculatral | Dashboard </title>
	<meta charset="UTF-8">
...
<!--===============================================================================================-->
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <div class="card-body">
             ...
             <div class="col-md-6 form-group">
                 <label>Name</label>
                 <input type="text" name="name" class="form-control" pattern="[a-zA-Z ]{3,20}" maxlength="20" placeholder="Usama" required>
             </div>  
              <div class="col-md-6 form-group">
                 <label>Surname</label>
                 <input type="text" name="surname" class="form-control" pattern="[a-zA-Z ]{3,20}" maxlength="20" placeholder="Tariq" required>
             </div>       
         ...
         <div class="row">
             <div class="col-md-6 form-group">
                 <label>Phone</label>
                 <input type="text" name="phone" class="form-control" pattern="03[0-9]{9}" maxlength="11" placeholder="03371236549" required>
             </div>  
  ...
  <select class="form-control" name="region">
    ...
    <option>Islamabad Capital Territory</option>
           ...
           Agriculatral <?php echo date('Y');?> &copy; All Rights Reserved &#9829; by Usama  
            </p>
            </footer>
           <div class="line"></div> 
